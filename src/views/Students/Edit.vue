    ...
    methods: {
        ...
        getStudentData(studentId) {
            ...
            axios.get(`http://localhost:8000/api/students/${studentId}/edit`).then(res => {
                ...
                //this.model.student.course = res.data.students.course
                //this.model.student.email= res.data.students.email
                //this.model.student.phone = res.data.students.phone
        ...
        updateStudent() {
            ...
            var $this = this;
            axios.put(`http://localhost:8000/api/students/${this.studentId}/edit`, this.model.student).then(res => {
